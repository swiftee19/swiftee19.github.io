...
export const ProjectsData: Array<Project> = [
    {
        id: 1,
        title: "Reef Rascals",
        description: "Reef Rascal is a Web3🌐 turn-based game where players collect and battle rascals (fighters) in an ICP token-based environment. Players can gacha, buy, and sell their rascals on a decentralized marketplace. The game is built using React with TypeScript and Motoko on the Internet Computer.",
